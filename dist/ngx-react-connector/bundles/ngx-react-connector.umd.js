(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('lodash'), require('react-dom'), require('react'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('ngx-react-connector', ['exports', '@angular/core', 'lodash', 'react-dom', 'react', '@angular/common'], factory) :
    (global = global || self, factory(global['ngx-react-connector'] = {}, global.ng.core, global.ng.lodash, global.ng['react-dom'], global.ng.react, global.ng.common));
}(this, (function (exports, core, lodash, reactDom, react, common) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var ReactConnectorComponent = /** @class */ (function () {
        ...
        ReactConnectorComponent.ɵcmp = core.ɵɵdefineComponent({ type: ReactConnectorComponent, selectors: [["rc-render-container"]], viewQuery: function ReactConnectorComponent_Query(rf, ctx) { if (rf & 1) {
                core.ɵɵviewQuery(_c0, true, core.ElementRef);
            } if (rf & 2) {
                var _t;
                core.ɵɵqueryRefresh(_t = core.ɵɵloadQuery()) && (ctx._containerRef = _t.first);
            } }, hostVars: 2, hostBindings: function ReactConnectorComponent_HostBindings(rf, ctx) { if (rf & 2) {
                core.ɵɵclassMap(ctx.class);
                ...
                core.ɵɵproperty("ngClass", ctx.classContainer);
            } }, directives: [common.NgClass], styles: [".react-connector[_ngcontent-%COMP%] { display:block; }"] });
        return ReactConnectorComponent;
    }());
    /*@__PURE__*/ (function () { core.ɵsetClassMetadata(ReactConnectorComponent, [{
            type: core.Component,
            args: [{
                ...
                type: core.ViewChild,
                args: ['container', { read: core.ElementRef }]
            }], reactComponentRef: [{
                type: core.Input
            }], props: [{
                type: core.Input
    ...
    var ReactConnectorDirective = /** @class */ (function () {
        ...
        ReactConnectorDirective.prototype.ngOnChanges = function (changes) {
            var propChange = !lodash.get(changes, 'reactProps.firstChange', true);
            var eventsChange = !lodash.get(changes, 'reactEvents.firstChange', true);
            var classContainerChange = !lodash.get(changes, 'reactClassContainer.firstChange', true);
        ...
        ReactConnectorDirective.ɵfac = function ReactConnectorDirective_Factory(t) { return new (t || ReactConnectorDirective)(core.ɵɵdirectiveInject(core.ViewContainerRef), core.ɵɵdirectiveInject(core.ComponentFactoryResolver), core.ɵɵdirectiveInject(core.Injector)); };
        ReactConnectorDirective.ɵdir = core.ɵɵdefineDirective({ type: ReactConnectorDirective, selectors: [["", "reactConnectorComponent", ""]], inputs: { reactConnectorComponent: "reactConnectorComponent", reactProps: "reactProps", reactEvents: "reactEvents", reactClassContainer: "reactClassContainer" }, features: [core.ɵɵNgOnChangesFeature] });
        return ReactConnectorDirective;
    }());
    /*@__PURE__*/ (function () { core.ɵsetClassMetadata(ReactConnectorDirective, [{
            type: core.Directive,
            args: [{
                    selector: '[reactConnectorComponent]'
                }]
        }], function () { return [{ type: core.ViewContainerRef }, { type: core.ComponentFactoryResolver }, { type: core.Injector }]; }, { reactConnectorComponent: [{
                type: core.Input,
    ...
    var ReactConnectorService = /** @class */ (function () {
        ...
        ReactConnectorService.prototype.updateProps = function (currentProps, newProps) {
            return lodash.merge({}, currentProps, newProps);
        };
        ReactConnectorService.prototype.updateEvents = function (currentEvents, newEvents) {
            return lodash.merge({}, currentEvents, newEvents);
        };
        ReactConnectorService.ɵfac = function ReactConnectorService_Factory(t) { return new (t || ReactConnectorService)(); };
        ReactConnectorService.ɵprov = core.ɵɵdefineInjectable({ token: ReactConnectorService, factory: ReactConnectorService.ɵfac });
        return ReactConnectorService;
    }());
    /*@__PURE__*/ (function () { core.ɵsetClassMetadata(ReactConnectorService, [{
    ...
    var ReactConnectorModule = /** @class */ (function () {
        ...
        ReactConnectorModule.ɵmod = core.ɵɵdefineNgModule({ type: ReactConnectorModule });
        ReactConnectorModule.ɵinj = core.ɵɵdefineInjector({ factory: function ReactConnectorModule_Factory(t) { return new (t || ReactConnectorModule)(); }, providers: [
    ...
    (function () { (typeof ngJitMode === "undefined" || ngJitMode) && core.ɵɵsetNgModuleScope(ReactConnectorModule, { declarations: [ReactConnectorComponent,
            ReactConnectorDirective], imports: [common.CommonModule], exports: [ReactConnectorDirective] }); })();
    /*@__PURE__*/ (function () { core.ɵsetClassMetadata(ReactConnectorModule, [{
            type: core.NgModule,
            args: [{
                    imports: [
                        common.CommonModule
    ...
    exports.ReactConnectorDirective = ReactConnectorDirective;
    exports.ReactConnectorModule = ReactConnectorModule;
    exports.ReactConnectorService = ReactConnectorService;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ngx-react-connector.umd.js.map
